...
from .. import shopify_api_extended
...
class ShopifyPaymentReportEpt(models.Model):
    ...
    def get_payout_report(self, start_date, end_date, instance):
        ...
        try:
            payout_reports = shopify_api_extended.Payout().find(status="paid", date_min=start_date, date_max=end_date,
                                                                limit=250)
    ...
    def create_payout_transaction_lines(self, payout_data):
        ...
        transactions = shopify_api_extended.Transaction().find(payout_id=self.payout_reference_id, limit=250)
    ...
    def create_bank_statement_lines_for_payout_report(self, bank_statement_id, regenerate=False):
        ...
        for transaction in transaction_ids:
            ...
            if transaction.transaction_type in ['charge', 'refund'] and not order_id:
                ...
                if order_id:
                    ...
                    message = "Transaction line {0} is skip due to order {1} is not found in odoo.".format(
        ...
        if log_lines:
            ...
            note = "Bank statement lines are not generated for Transaction ids : "
