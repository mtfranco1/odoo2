...
class ShopifyProductDataQueue(models.Model):
    ...
    def shopify_create_product_data_queue(self, instance, skip_existing_product=False, template_ids=""):
        ...
        :param skip_existing_product: skip_existing_product False then it will update product values existing
        sync product, if True then it will not update product values in existing products.
