...
class ShopifyInstanceEpt(models.Model):
    ...
    def get_total_orders(self, record):
        ...
        view = self.env.ref('shopify_ept.action_shopify_sales_order').read()[0]
    ...
    def get_total_products(self, record):
        ...
        view = self.env.ref('shopify_ept.action_shopify_product_exported_ept').read()[0]
    ...
    def get_customers(self, record):
        ...
        view = self.env.ref('shopify_ept.action_shopify_partner_form').read()[0]
    ...
    def get_refund(self, record):
        ...
        view = self.env.ref('shopify_ept.action_refund_shopify_invoices').read()[0]
    ...
    def perform_operation(self, record_id):
        ...
        """
        view = self.env.ref('shopify_ept.action_wizard_shopify_instance_import_export_operations').read()[0]
    ...
    def open_report(self, record_id):
        ...
        """
        view = self.env.ref('shopify_ept.shopify_sale_report_action_dashboard').read()[0]
    ...
    def open_logs(self, record_id):
        ...
        """
        view = self.env.ref('shopify_ept.action_common_log_book_ept_shopify').read()[0]
